...
<nav class="body" >
  ...
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item"><a href="\CGV\Phimdangchieu.php">Phim Đang Chiếu</a></li>
    <li class="breadcrumb-item active" aria-current="page" style="text-decoration: underline">Phim Sắp Chiếu </li>
  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-sm-12">
        <a href="\CGV\Phimdangchieu.php" ><h4 style="float:right">Phim Đang Chiếu</h4></a>
      </div>  
    </div>
    <hr class="hr1">
</div>
  ...
  require_once('conn.php');
      ...
      $sql = "SELECT id,name,daodien,dienvien,TheLoai,ThoiLuong,KhoiChieu,NgonNgu,MoTa,image FROM phimsapchieu";
  ...
  ?>
      <div class="col-sm-3">
      <a href="chitietphimsapchieu.php?id=<?= $row['id'] ?>"><img src="<?= $row['image'] ?>" width="185px" height="260px"></a>
      <div>
      <h4 id="P"><a href="chitietphimsapchieu.php?id=<?= $row['id'] ?>"><?= $row['name'] ?></a></h4>
