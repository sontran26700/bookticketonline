...
<nav class="body" >
  ...
  <div class="dropdown">
    ...
    <div class="dropdown-content">
      ...
      <a href="\CGV\Tatcacacrap.php ">Rạp Đặc Biệt</a>
      <a href="\CGV\Tatcacacrap.php">Rạp Sắp Mở</a>
    </div>
  </div>
    ...
    <div class="container">
      <div class="row">
        <div class="col-sm-12 text-center">
          <h1 style="color:red">CGV CINEMAS</h1>
        </div>
      </div>
     
      <div class="text-center">
      <button class="button button4"><a href="\CGV\Tatcacacrap.php">HỒ CHÍ MINH</a></button>
      <button class="button button4"><a href="\CGV\Tatcacacrap.php">GÒ VẤP</a></button>
      <button class="button button4"><a href="\CGV\Tatcacacrap.php">ĐỒNG NAI</a></button>
  ...
  <img src="<?= $row['image'] ?>" alt="Notebook" style="width:100%;">
  <div class="content">
    <a href="\CGV\rapvivo.php"><button class="btn btn-danger">Lịch Chiếu</button></a>
    <p><?= $row['place'] ?></p>
    <p>FAX :<?= $row['FAX'] ?></p>
    <p>Hotline : <?= $row['sdt'] ?></p>
  </div>
