      ...
      <div class="row">
        <div class="col-md order-md-1">
          <form action="addproduct.php" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3">
              <label for="daodien">Dao Dien</label>
              <div class="input-group">
			...
			<div class="mb-3">
			 ...
			 <div class="form-group">
                <label class="contentrol-label" for="KhoiChieu">Release Date</label>
                <input type="text" name="KhoiChieu" id="KhoiChieu" class="form-control"/>
